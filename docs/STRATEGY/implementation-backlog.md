...
10. **Crew app Phases 2–3 (17 Sep).** Phase 1 live on production. Pay sheet and tablet Day Board/walk-up are in the working tree. Next: deploy, then a planned field pass. Encrypted offline stays Phase 4.
