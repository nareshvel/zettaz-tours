...
10. **Crew app Phase 1 (17 Sep).** Roster search, pickup sequence, start/no-show, clearance badges are implemented. Remaining: commit/push, VPS deploy, device pass, then Phase 2 Pay. Encrypted offline and retained waiver PDF stay Phase 4 / server.
