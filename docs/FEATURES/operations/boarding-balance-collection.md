...
- Crew mobile on-device Pay sheet (web manifest Pay exists; mobile still server-gates on clearance). Sequenced as Phase 2 in [crew-app-delivery.md](../../STRATEGY/crew-app-delivery.md).
