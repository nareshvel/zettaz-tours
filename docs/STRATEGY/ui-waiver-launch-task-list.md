...
| 17 | **Subscription — messaging implemented 19 Sep 2026; cycle toggle CSS 20 Sep; needs owner visual pass** | Plan grid + profile embedding 11 Sep; billing-cycle / failed-payment / 3-day grace / post-suspension copy 19 Sep; Monthly/Yearly uses shared `.billing-cycle`. See [subscription-polish-evidence.md](../TESTING/subscription-polish-evidence.md). |
