...
const PLANS = [
  {
    ...
    name: "Essentials",
    description:
      "Core booking and operations for small tour and charter businesses.",
    monthly_minor: 7900,
    yearly_minor: 79900,
    features: [
  ...
  },
  {
    ...
    name: "Operations",
    description:
      "Full operational capability for tour businesses with crews, vehicles, and waivers.",
    monthly_minor: 14900,
    yearly_minor: 149000,
    features: [
  ...
  },
  {
    ...
    name: "Growth",
    description:
      "Multi-channel and partner capability for growing tour operators.",
    monthly_minor: 24900,
    yearly_minor: 249000,
    features: [
  ...
  },
  {
    ...
    name: "Enterprise",
    description:
      "Customisable platform and priority support for larger operators.",
    monthly_minor: 59900,
    yearly_minor: 599000,
    features: [
...
async function main() {
  ...
  for (const plan of PLANS) {
    ...
    const pm = await findOrCreatePrice(
      product.id,
      plan.id,
      "month",
      plan.monthly_minor,
    ...
    const py = await findOrCreatePrice(
      product.id,
      plan.id,
      "year",
      plan.yearly_minor,
