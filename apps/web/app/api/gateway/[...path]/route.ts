...
const paths: Record<string, RegExp> = {
  ...
  DELETE:
    /^(ops\/v1\/(resources\/[a-f0-9-]{36}|crew\/[a-f0-9-]{36}|compliance-documents\/[a-f0-9-]{36}|assignments\/[a-f0-9-]{36}|pickup-locations\/[a-f0-9-]{36}|waiver-templates\/[a-f0-9-]{36})|finance\/v1\/(vendors\/[a-f0-9-]{36}|expense-categories\/[a-f0-9-]{36}|expenses\/[a-f0-9-]{36}|partners\/[a-f0-9-]{36}\/(bookings\/[a-f0-9-]{36}|settlements\/[a-f0-9-]{36})))$/,
};
