...
const paths: Record<string, RegExp> = {
  GET: /^(crew\/v1\/today|staff\/v1\/(workspace\/(session|departures|reservations|members|roles|summary|briefing|notifications|subscription)|customers(?:\/[a-f0-9-]{36})?|departures\/[a-f0-9-]{36}\/availability|bookings\/[a-f0-9-]{36}(\/(changes|passengers|notifications))?)|admin\/v1\/(tenant(?:\/readiness)?|products(?:\/[a-f0-9-]{36})?|availability-rules(?:\/[a-f0-9-]{36})?|invitations|support-access)|integrations\/v1\/(accounts|mappings|inbox|assisted-imports)|finance\/v1\/(finance-overview|vendors(?:\/[a-f0-9-]{36})?|expense-categories(?:\/[a-f0-9-]{36})?|expenses(?:\/[a-f0-9-]{36})?|partners(?:\/available|\/[a-f0-9-]{36}\/(?:bookings\/(unsettled|unsettled-summary)|ledger|settlements(?:\/[a-f0-9-]{36})?))?|partner-aging|partner-claims|partner-statements|partner-finance-summary|bookings\/[a-f0-9-]{36}\/finance-summary)|ops\/v1\/(audit|board|resources|crew|compliance-documents(?:\/[a-f0-9-]{36}\/file)?|document-library\/usage|assignments|print-templates|print-jobs(?:\/[a-f0-9-]{36}\/pdf)?|pickup-locations|waiver-templates|stays\/(options|vessels)|bookings\/[a-f0-9-]{36}\/waivers|passengers\/[a-f0-9-]{36}\/waiver|departures\/[a-f0-9-]{36}\/(manifest|pickups|pickup-list|assignments|rebooking-options)))$/,
