...
- The customer list searches name, email or phone and highlights the number of linked bookings. Repeated email addresses resolve to one record and make potential duplicate history visible.
- Customer detail shows linked bookings and a timeline of travel dates, payments, waivers, customer-message requests, amendments and cancellations.
...
- Purchaser and emergency contact remain visible on the booking and customer booking history.
