...
- Crew mobile on-device Pay sheet (web manifest Pay exists). Phase 2 implemented; production device pass pending. See [crew-app-delivery.md](../../STRATEGY/crew-app-delivery.md).
