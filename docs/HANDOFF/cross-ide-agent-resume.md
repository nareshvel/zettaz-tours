...
2. **Phase 5.1 guest kiosk** + Crew **Share PDF** (pickup/receipt) engineering 19 Sep. GPS, Terminal, push, white-label still gated. Next engineering is gated unless testing finds a Crew defect; owner visual + 4.8 + EAS.
