...
const routes: [string, string, z.ZodType | null, string][] = [
  ...
  [
    "/crew/v1/bookings/{id}/payments",
    "post",
    null,
    "Record a settled boarding payment on an assigned crew trip",
  ],
  [
    "/crew/v1/board",
    "get",
    null,
    "Read today's operations board for tablet desk roles",
  ],
  [
    "/crew/v1/board/{id}",
    "get",
    null,
    "Open one departure's boarding roster from the tablet Day Board",
  ],
  [
    "/crew/v1/walk-ups",
    "post",
    null,
    "Create a walk-up hold, guest, roster, optional payment, and confirm",
  ],
  [
    "/crew/v1/departures/{id}/operational-status",
    "post",
    null,
    "Weather-hold, close, or reopen a departure from the tablet board",
  ],
  [
    "/crew/v1/departures/{id}/pickup-list",
    "get",
    null,
    "Read the printable pickup sequence for tablet share",
  ],
  [
    "/crew/v1/print-jobs",
    "post",
    null,
    "Request a pickup-list or receipt PDF from the crew tablet",
  ],
  [
    "/crew/v1/print-jobs/{id}/pdf",
    "get",
    null,
    "Download a crew-requested pickup-list or receipt PDF",
  ],
